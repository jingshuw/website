...
4| 2022-04-26 | Two case studies, non-compliance in randomized experiments |  {{% staticref "materials/stat246_2022/Lecture9.pdf" "newtab" %}}Lecture 9{{% /staticref %}} | {{% staticref "materials/stat246_2022/R_example4.nb.html" "newtab" %}}R Example for case study{{% /staticref %}}, {{% staticref "materials/stat246_2022/HOMEFOOD.tab" "newtab" %}}HOMEFOOD.tab{{% /staticref %}} |--- 
